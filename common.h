...
typedef enum {ENDBRACE, RULESET, ACT_CALL, ACT_IGNORE, ACT_SYSLOG_CRIT, ACT_SYSLOG_WARN, ACT_SYSLOG, ACT_LOG, ACT_EXEC, ACT_XATTR, ACT_DIRLOG, ACT_SEND, ACT_MAIL, ACT_ALLOW, ACT_DENY, ACT_ADDLIST, ACT_XACHANGELAST, ACT_XACHANGELOG, ACT_FREEZEPROC, ACT_FREEZEPARENT, ACT_KILLPROC, ACT_KILLPARENT, ACT_RETURN, ACT_MD5, ACT_SHA1, ACT_SHA256} TAction;
